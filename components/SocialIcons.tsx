const SOCIAL_LINKS = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/people/Active-digital-solution/61587581475845/",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/activedigitalsolution?igsh=OGV6ZnFlMGc3eHM0",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6" aria-hidden>
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@active_digital_solution?_r=1&_t=ZS-93y9DBks1hK",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6" aria-hidden>
